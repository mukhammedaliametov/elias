...
const SectionTitle = ({name, button}) => {
    ...
    return (
        <div className='max-w-[1220px] mx-auto flex justify-between items-center text-white font-firacode pt-[30px]'>
            ...
            <a href='#' className='hidden md:flex text-[16px] items-center gap-[8px] capitalize hover:text-primary duration-300 cursor-pointer'>{button} {button !== undefined && <HiOutlineArrowLongRight className='text-[25px]' />}</a>
        </div>
    );
};
